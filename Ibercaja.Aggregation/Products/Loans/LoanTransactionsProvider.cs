...
{
    public class LoanTransactionsProvider : ITransactionsProvider
    {
        private static readonly ILog Logger = LogManager.GetLogger(typeof(LoanTransactionsProvider));

        private readonly IAggregationService _aggregationService;

        public LoanTransactionsProvider(IAggregationService aggregationService)
        {
