...
{
    public class EurobitsUserDataConnectorDefault : EurobitsUserDataConnector
    {
        public EurobitsUserDataConnectorDefault(string data, RealmUser realmUser)
            : base(
                  GetEurobitsApi(),
        ...
        {
            return IoC.Resolve<IEurobitsApiService>("Default");
        }
